...
for key, value in controllers.items():
	...
	print ("subscribe \"precommit:" + arg + ".system_mode <- controller_" + key + "/system_mode\";", file=op)
	houseNumber = arg.split("_")
	print ("publish \"commit:trip_meter" + houseNumber[1]+"_" + houseNumber[2] + ".measured_real_energy -> " + arg + "/realPowerkWh\";", file=op)
	#print ("subscribe \"precommit:trip_meter" + houseNumber[1]+"_" + houseNumber[2] + ".measured_real_energy <- " + 'auction_Market_1' + "/ResetRealPower\";", file=op)
op.close()
