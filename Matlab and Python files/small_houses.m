...
for i=1:15
    for j=1:12
     ...
     fprintf(write_file,'floor_area random.normal(700,100);\n');
     
     %cooling_setpoint controller.house_15_6_thermostat_controller_cooling_setpoint
	 fprintf(write_file,'cooling_setpoint 76;\n');
     %fprintf(write_file,'%u',i);fprintf(write_file,'_');fprintf(write_file,'%u',j);
     %fprintf(write_file,'_thermostat_controller_cooling_setpoint;\n');
     
     
	 fprintf(write_file,'thermostat_deadband 1;\n');
     fprintf(write_file,'ceiling_height 8;\n');
     fprintf(write_file,'window_wall_ratio 0.1;\n');
     fprintf(write_file,'Rwall random.normal(4,0.1);\n');
     fprintf(write_file,'Rwindows random.normal(0.78,0.1);\n');
     fprintf(write_file,'Rroof random.normal(11,1);\n');
     fprintf(write_file,'Rdoors random.normal(3,1);\n');
     fprintf(write_file,'Rfloor random.normal(4,1);\n');
     fprintf(write_file,'number_of_doors 1;\n');
     fprintf(write_file,'airchange_per_hour 1.5;\n');
...
fprintf(write_file,'object recorder {\n');
	...
	fprintf(write_file,'parent "SpokaneWA";\n');
